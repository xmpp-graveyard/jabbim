...
#
# Created: Tue Oct 23 08:34:32 2007
...
class Ui_serviceDiscovery(object):
    def setupUi(self, serviceDiscovery):
        ...
        serviceDiscovery.resize(QtCore.QSize(QtCore.QRect(0,0,717,298).size()).expandedTo(serviceDiscovery.minimumSizeHint()))
        ...
        self.search = QtGui.QPushButton(serviceDiscovery)
        ...
        self.register = QtGui.QPushButton(serviceDiscovery)
        self.register.setObjectName("register")
        self.gridlayout.addWidget(self.register,1,2,1,1)
    ...
    def retranslateUi(self, serviceDiscovery):
        ...
        self.search.setText(QtGui.QApplication.translate("serviceDiscovery", "Search", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.register.setText(QtGui.QApplication.translate("serviceDiscovery", "Register", None, QtGui.QApplication.UnicodeUTF8))
