...
#
# Created: Sun Jan 27 20:01:45 2008
...
class Ui_albumFiletransferDialog(object):
    def setupUi(self, albumFiletransferDialog):
        ...
        albumFiletransferDialog.resize(QtCore.QSize(QtCore.QRect(0,0,476,451).size()).expandedTo(albumFiletransferDialog.minimumSizeHint()))
