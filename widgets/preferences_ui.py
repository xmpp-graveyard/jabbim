...
class Ui_preferences(object):
    def setupUi(self, preferences):
        ...
        icon = QtGui.QIcon()
        icon.addFile("../../../../.designer/backup/images/16x16/apps/jabbim.png")
        ...
        self.moreChatSkins = QtGui.QTabWidget(self.page_3)
        ...
        self.moreChatSkins.addTab(self.tab, "")
        ...
        spacerItem5 = QtGui.QSpacerItem(201, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.moreChatSkins.addTab(self.tab_4, "")
        ...
        self.moreEmoticons_2 = QtGui.QPushButton(self.tab_2)
        self.moreEmoticons_2.setObjectName("moreEmoticons_2")
        self.gridlayout9.addWidget(self.moreEmoticons_2, 3, 1, 1, 1)
        self.moreChatSkins.addTab(self.tab_2, "")
        ...
        spacerItem7 = QtGui.QSpacerItem(271, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridlayout10.addItem(spacerItem7, 3, 0, 1, 1)
        ...
        self.moreChatSkins.addTab(self.tab_3, "")
        self.gridlayout6.addWidget(self.moreChatSkins, 2, 0, 1, 1)
        ...
        spacerItem8 = QtGui.QSpacerItem(261, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridlayout11.addItem(spacerItem8, 3, 0, 1, 1)
        ...
        spacerItem9 = QtGui.QSpacerItem(141, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.moreChatSkins.setCurrentIndex(0)
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:\'Sans Serif\';\"><span style=\" font-size:12pt; font-weight:600;\">View</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.moreChatSkins.setTabText(self.moreChatSkins.indexOf(self.tab), QtGui.QApplication.translate("preferences", "Themes", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.moreChatSkins.setTabText(self.moreChatSkins.indexOf(self.tab_4), QtGui.QApplication.translate("preferences", "Groupchat skin", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.moreEmoticons_2.setText(QtGui.QApplication.translate("preferences", "Get more chat skins", None, QtGui.QApplication.UnicodeUTF8))
        self.moreChatSkins.setTabText(self.moreChatSkins.indexOf(self.tab_2), QtGui.QApplication.translate("preferences", "Chat skin", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.moreChatSkins.setTabText(self.moreChatSkins.indexOf(self.tab_3), QtGui.QApplication.translate("preferences", "Emoticons", None, QtGui.QApplication.UnicodeUTF8))
