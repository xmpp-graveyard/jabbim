...
#
# Created: Fri Apr 10 06:46:48 2009
...
class Ui_preferences(object):
    def setupUi(self, preferences):
        ...
        self.viewStackedWidget = QtGui.QStackedWidget(self.page_3)
        ...
        self.gridlayout6.addLayout(self.hboxlayout1, 0, 0, 1, 2)
        ...
        self.gridlayout6.addWidget(self.groupchatskinInfo, 1, 0, 1, 2)
        self.groupchatskinPreview = QtWebKit.QWebView(self.tab_4)
        self.groupchatskinPreview.setObjectName("groupchatskinPreview")
        self.gridlayout6.addWidget(self.groupchatskinPreview, 2, 0, 1, 2)
        ...
        self.gridlayout6.addWidget(self.moreGroupchatSkins, 3, 1, 1, 1)
        ...
        self.gridlayout7.addLayout(self.hboxlayout2, 0, 0, 1, 2)
        ...
        self.gridlayout8.addItem(spacerItem8, 3, 0, 1, 1)
        ...
        spacerItem9 = QtGui.QSpacerItem(378, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_4.addItem(spacerItem9, 1, 0, 1, 1)
        self.normalView = QtGui.QPushButton(self.page)
        self.normalView.setObjectName("normalView")
        self.gridLayout_4.addWidget(self.normalView, 1, 1, 1, 1)
        self.viewStackedWidget.addWidget(self.page)
        self.page_7 = QtGui.QWidget()
        self.page_7.setObjectName("page_7")
        self.gridLayout_6 = QtGui.QGridLayout(self.page_7)
        ...
        self.themePackages = QtGui.QComboBox(self.page_7)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.themePackage = QtWebKit.QWebView(self.page_7)
        self.themePackage.setUrl(QtCore.QUrl("about:blank"))
        self.themePackage.setObjectName("themePackage")
        self.gridLayout_6.addWidget(self.themePackage, 1, 0, 1, 2)
        spacerItem10 = QtGui.QSpacerItem(347, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_6.addItem(spacerItem10, 2, 0, 1, 1)
        self.advancedView = QtGui.QPushButton(self.page_7)
        self.advancedView.setObjectName("advancedView")
        self.gridLayout_6.addWidget(self.advancedView, 2, 1, 1, 1)
        self.viewStackedWidget.addWidget(self.page_7)
        self.gridLayout_5.addWidget(self.viewStackedWidget, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem11, 7, 0, 1, 1)
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px; font-family:\'Sans Serif\';\"><span style=\" font-size:12pt; font-weight:600;\">View</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.normalView.setText(QtGui.QApplication.translate("preferences", "Back", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("preferences", "Style:", None, QtGui.QApplication.UnicodeUTF8))
        self.advancedView.setText(QtGui.QApplication.translate("preferences", "Advanced", None, QtGui.QApplication.UnicodeUTF8))
