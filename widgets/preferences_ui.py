...
#
# Created: Fri Jun 13 19:06:23 2008
...
class Ui_preferences(object):
    def setupUi(self, preferences):
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 462, 446))
        ...
        self.tab.setGeometry(QtCore.QRect(0, 0, 440, 361))
        ...
        self.tab_2.setGeometry(QtCore.QRect(0, 0, 440, 361))
        ...
        self.gridLayout.addWidget(self.chatSkin_list, 0, 0, 1, 1)
        self.chatskinVariant = QtGui.QComboBox(self.tab_2)
        self.chatskinVariant.setObjectName("chatskinVariant")
        self.gridLayout.addWidget(self.chatskinVariant, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.chatSkinInfo, 2, 0, 1, 1)
        self.chatskinPreview = QtWebKit.QWebView(self.tab_2)
        self.chatskinPreview.setObjectName("chatskinPreview")
        self.gridLayout.addWidget(self.chatskinPreview, 3, 0, 1, 1)
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtGui.QWidget()
        self.tab_3.setGeometry(QtCore.QRect(0, 0, 440, 361))
        ...
        item.setIcon(icon1)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("images/32x32/categories/system-users.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item = QtGui.QListWidgetItem(self.listWidget)
        item.setIcon(icon3)
        item = QtGui.QListWidgetItem(self.listWidget)
        item.setIcon(icon1)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("images/32x32/categories/preferences-desktop-theme.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item = QtGui.QListWidgetItem(self.listWidget)
        item.setIcon(icon4)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("images/32x32/categories/applications-accessories.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item = QtGui.QListWidgetItem(self.listWidget)
        item.setIcon(icon5)
