...
#
# Created: Wed Dec  5 19:02:56 2007
...
class Ui_VCardEdit(object):
    def setupUi(self, VCardEdit):
        ...
        spacerItem1 = QtGui.QSpacerItem(75,71,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        self.gridlayout1.addItem(spacerItem1,5,1,1,1)
