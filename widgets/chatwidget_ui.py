...
#
# Created: Sat Nov  3 18:26:06 2007
...
class Ui_chatwidget(object):
    def setupUi(self, chatwidget):
        ...
        self.boldButton = QtGui.QPushButton(chatwidget)
        self.boldButton.setCheckable(True)
        self.boldButton.setObjectName("boldButton")
        self.gridlayout.addWidget(self.boldButton,1,2,1,1)

        spacerItem = QtGui.QSpacerItem(301,29,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Minimum)
        ...
        self.gridlayout.addLayout(self.hboxlayout,1,3,1,1)
