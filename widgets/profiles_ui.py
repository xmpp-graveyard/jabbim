...
class Ui_profilesWindow(object):
    def setupUi(self, profilesWindow):
        ...
        profilesWindow.resize(QtCore.QSize(QtCore.QRect(0,0,322,301).size()).expandedTo(profilesWindow.minimumSizeHint()))
        profilesWindow.setWindowIcon(QtGui.QIcon("images/16x16/apps/jabbim.png"))
