...
class Ui_fileTransfer(object):
    def setupUi(self, fileTransfer):
        ...
        fileTransfer.resize(QtCore.QSize(QtCore.QRect(0,0,470,310).size()).expandedTo(fileTransfer.minimumSizeHint()))
        fileTransfer.setWindowIcon(QtGui.QIcon("images/16x16/apps/jabbim.png"))
