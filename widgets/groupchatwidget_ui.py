...
#
# Created: Thu May 24 14:24:14 2007
...
class Ui_groupchatwidget(object):
    def setupUi(self, groupchatwidget):
        ...
        groupchatwidget.resize(QtCore.QSize(QtCore.QRect(0,0,487,379).size()).expandedTo(groupchatwidget.minimumSizeHint()))
        ...
        self.gridlayout.addWidget(self.lineWidget,3,0,1,4)
        ...
        self.gridlayout.addWidget(self.smileys,4,2,1,1)
        ...
        self.gridlayout.addWidget(self.admin,2,1,1,3)
        ...
        self.gridlayout.addWidget(self.users,1,1,1,3)
        ...
        self.gridlayout.addLayout(self.gridlayout1,0,0,1,4)
