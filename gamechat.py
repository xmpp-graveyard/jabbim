...
from gamechatwidget_ui import *
from configobj import ConfigObj

class gameChatWidget(QtGui.QWidget):
	def __init__(self,main,jid,jab,parent=None):
		apply(QtGui.QWidget.__init__,(self,parent))
		self.jab=jab
		self.ui=Ui_gamechatwidget()
		self.ui.setupUi(self)
		self.main=main
		QtCore.QObject.connect(self.ui.sendButton, QtCore.SIGNAL("clicked ()"),self.sendButtonClicked)
		QtCore.QObject.connect(self.ui.startGame, QtCore.SIGNAL("clicked ()"),self.start)
