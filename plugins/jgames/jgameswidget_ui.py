...
# Form implementation generated from reading ui file 'plugins/jgames/jgameswidget.ui'
#
# Created: Tue Mar 11 10:21:16 2008
...
class Ui_groupchatwidget(object):
    def setupUi(self, groupchatwidget):
        ...
        groupchatwidget.resize(QtCore.QSize(QtCore.QRect(0,0,517,560).size()).expandedTo(groupchatwidget.minimumSizeHint()))
        ...
        self.gameWidget = QtGui.QWidget(self.splitter_2)
        ...
        self.vboxlayout1.addWidget(self.lineWidget)
        ...
        self.gridlayout.addWidget(self.splitter_2,0,0,2,2)

        self.selfAvatar = QtGui.QLabel(groupchatwidget)
        ...
        self.gridlayout.addWidget(self.selfAvatar,1,1,1,1)
