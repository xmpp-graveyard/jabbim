...
# Form implementation generated from reading ui file 'widgets/privacy.ui'
#
# Created: Wed Nov  7 06:36:59 2007
...
class Ui_PrivacyListEditor(object):
    def setupUi(self, PrivacyListEditor):
        ...
        PrivacyListEditor.resize(QtCore.QSize(QtCore.QRect(0,0,400,300).size()).expandedTo(PrivacyListEditor.minimumSizeHint()))
