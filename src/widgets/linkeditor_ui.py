...
# Form implementation generated from reading ui file 'widgets/linkeditor.ui'
#
# Created: Wed Feb  6 13:34:08 2008
...
class Ui_linkEditor(object):
    def setupUi(self, linkEditor):
        ...
        linkEditor.resize(QtCore.QSize(QtCore.QRect(0,0,429,115).size()).expandedTo(linkEditor.minimumSizeHint()))
        linkEditor.setWindowIcon(QtGui.QIcon("images/16x16/apps/jabbim.png"))
